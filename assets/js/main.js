...
if (isNaN(kms) || kms <= 0) {
  ...
  if (isNaN(userAge) || userAge < 0) {
    ...
    // USATO TOFIXED PER MOSTRARE DECIMALI ANCHE IN CASO DI ".00"
    ...
    finalPriceContainer.innerHTML = `<p>Km da percorrere: ${kms}</p>
    <p>Età passeggero: ${userAge}</p>
    <p>Il costo del tuo biglietto sarà di</p>
    <p style="color: green; text-decoration: underline">${priceToShow}€</p>`;
  }
}
